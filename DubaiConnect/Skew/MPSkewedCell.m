...
- (void)setupLabelIfNeeded:(NSString *)text {
    if (text) {
        if (!self.gradient) {
            ...
            gradient.colors = @[(id)[UIColor colorWithRed:97 green:170 blue:250 alpha:0.5].CGColor,(id)[UIColor clearColor].CGColor];
        ...
        if (!self.textLabel) {
            ...
            textLabel.font = [UIFont fontWithName:@"Emirates SL" size:38];
